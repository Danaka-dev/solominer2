...
public:
    ...
    FailoverStrategy(Controller *controller,const std::vector<Pool> &pool, int retryPause, int retries, IStrategyListener *listener, bool quiet = false);
    FailoverStrategy(Controller *controller,int retryPause, int retries, IStrategyListener *listener, bool quiet = false);
...
protected:
    ...
    inline INetwork *network() const override;
