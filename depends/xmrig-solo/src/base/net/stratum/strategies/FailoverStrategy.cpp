...
xmrig::FailoverStrategy::FailoverStrategy(Controller *controller,const std::vector<Pool> &pools, int retryPause, int retries, IStrategyListener *listener, bool quiet) :
    m_quiet(quiet),
    m_retries(retries),
...
xmrig::FailoverStrategy::FailoverStrategy(Controller *controller,int retryPause, int retries, IStrategyListener *listener, bool quiet) :
    m_quiet(quiet),
    m_retries(retries),
    m_retryPause(retryPause),
    m_listener(listener),
...
xmrig::INetwork *xmrig::FailoverStrategy::network() const {
    return reinterpret_cast<INetwork *>(m_controller->network());
}
