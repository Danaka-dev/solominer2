...
xmrig::SinglePoolStrategy::SinglePoolStrategy(Controller *controller,const Pool &pool, int retryPause, int retries, IStrategyListener *listener, bool quiet) :
    m_active(false),
    m_listener(listener),
...
xmrig::INetwork *xmrig::SinglePoolStrategy::network() const {
