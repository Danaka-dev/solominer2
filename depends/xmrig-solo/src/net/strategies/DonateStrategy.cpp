...
#   endif
    ...
    if (m_pools.size() > 1) {
        m_strategy = new FailoverStrategy(m_controller ,m_pools, 10, 2, this, true);
    }
    else {
        m_strategy = new SinglePoolStrategy(m_controller ,m_pools.front(), 10, 2, this, true);
    }
...
xmrig::INetwork *xmrig::DonateStrategy::network() const {
